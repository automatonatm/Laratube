                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST"
                            ...
                            <div class="form-group row justify-content-center @error('image') is-invalid @enderror">
                                <div class="channel-avatar">
                                    ...
                                    <img src="{{$channel->image()}}" style="width: 100px; height: 100px;">
                        ...
                        @if($channel->editable())
                                <input  onchange="document.getElementById('update-form').submit()"
                                        accept="image/*"
                                        id="image" style="display: none;" type="file"  name="image">

                                <div class="form-group">
                                    <label for="name" class="form-control-label">Name</label>
                                    <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{old('name') ?: $channel->name}}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    <label for="desc" class="form-control-label">Channel Description</label>
                                    <textarea  name="description"
                                               id="desc" cols="3" rows="2"
                                               class="form-control  @error('description') is-invalid @enderror">{{old('description') ?: $channel->description }}</textarea>
